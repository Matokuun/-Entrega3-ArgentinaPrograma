...
/**
 * Clase que nos permite representar un partido de futbol
 */
public class Partido {
  ...
  public String toString() {
	return this.equipo1.getNombre() +" "+ this.golesEquipo1+ " - "+
      this.golesEquipo2+ " "+ this.equipo2.getNombre();
  }
  /**
   * Metodo que nos permite ver si el equipo recibido
   * como parametro le gano, empato o perdio
